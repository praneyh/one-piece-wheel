...
export const PARAMECIA_FRUITS = fruitList(
  [
    ['Gomu Gomu no Mi (Gum-Gum Fruit)', 1],
    ['Bara Bara no Mi (Chop-Chop Fruit)', 3],
    ['Sube Sube no Mi (Slip-Slip Fruit)', 3],
    ['Kilo Kilo no Mi (Kilo-Kilo Fruit)', 3],
    ['Bomu Bomu no Mi (Bomb-Bomb Fruit)', 3],
    ['Toge Toge no Mi (Spike-Spike Fruit)', 3],
    ['Ori Ori no Mi (Bind-Bind Fruit)', 3],
    ['Doru Doru no Mi (Wax-Wax Fruit)', 3],
    ['Baku Baku no Mi (Munch-Munch Fruit)', 3],
    ['Mane Mane no Mi (Clone-Clone Fruit)', 2],
    ['Hana Hana no Mi (Flower-Flower Fruit)', 2],
    ['Suke Suke no Mi (Clear-Clear Fruit)', 2],
    ['Horo Horo no Mi (Hollow-Hollow Fruit)', 2],
    ['Yomi Yomi no Mi (Revive-Revive Fruit)', 2],
    ['Nikyu Nikyu no Mi (Paw-Paw Fruit)', 1],
    ['Ito Ito no Mi (String-String Fruit)', 2],
    ['Mero Mero no Mi (Love-Love Fruit)', 2],
    ['Doku Doku no Mi (Venom-Venom Fruit)', 2],
    ['Bane Bane no Mi (Spring-Spring Fruit)', 2],
    ['Noro Noro no Mi (Slow-Slow Fruit)', 2],
    ['Ope Ope no Mi (Op-Op Fruit)', 1],
    ['Gura Gura no Mi (Tremor-Tremor Fruit)', 1],
    ['Nui Nui no Mi (Stitch-Stitch Fruit)', 2],
  ],
  PARAMECIA_PALETTE,
)
...
export const LOGIA_FRUITS = fruitList(
  [
    ['Mera Mera no Mi (Flame-Flame Fruit)', 2],
    ['Hie Hie no Mi (Ice-Ice Fruit)', 2],
    ['Suna Suna no Mi (Sand-Sand Fruit)', 2],
    ['Goro Goro no Mi (Rumble-Rumble Fruit)', 1],
    ['Pika Pika no Mi (Glint-Glint Fruit)', 1],
    ['Yami Yami no Mi (Dark-Dark Fruit)', 1],
    ['Moku Moku no Mi (Smoke-Smoke Fruit)', 2],
    ['Gasu Gasu no Mi (Gas-Gas Fruit)', 2],
    ['Numa Numa no Mi (Swamp-Swamp Fruit)', 2],
    ['Magu Magu no Mi (Magma-Magma Fruit)', 1],
  ],
  LOGIA_PALETTE,
)
